...
public class HomeFragment extends Fragment {
    ...
    public void updateData() {
        ...
        retrieveWeatherData(weather_url);
    }

    private void displayWeatherData(JSONObject weatherResponse) {
        JSONObject weeklyWeather = null;
        try {
            weeklyWeather = weatherResponse.getJSONObject("daily");
            ...
            ImageView weatherIcon = masterView.findViewById(R.id.weatherIcon);
            ...
            // set sun times
            TextView sunInfo = masterView.findViewById(R.id.sunTimesView);
            String sunData = "Sunrise " + todaysWeather.sunRise + ", setting at "+ todaysWeather.sunSet;
            sunInfo.setText(sunData);
    ...
    private void retrieveWeatherData(String url) {
